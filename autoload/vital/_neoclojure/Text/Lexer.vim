...
execute join(['function! vital#_neoclojure#Text#Lexer#import() abort', printf("return map({'lexer': '', '_vital_depends': '', 'simple_parser': '', '_vital_loaded': ''}, \"vital#_neoclojure#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
