...
let s:___revitalizer_functions___ = {'_vital_depends': s:___revitalizer_function___('s:_vital_depends'),'_vital_loaded': s:___revitalizer_function___('s:_vital_loaded'),'consume': s:___revitalizer_function___('s:consume'),'consume_all_blocking': s:___revitalizer_function___('s:consume_all_blocking'),'is_available': s:___revitalizer_function___('s:is_available'),'is_busy': s:___revitalizer_function___('s:is_busy'),'is_done': s:___revitalizer_function___('s:is_done'),'log_clear': s:___revitalizer_function___('s:log_clear'),'log_dump': s:___revitalizer_function___('s:log_dump'),'of': s:___revitalizer_function___('s:of'),'queue': s:___revitalizer_function___('s:queue'),'shutdown': s:___revitalizer_function___('s:shutdown'),'tick': s:___revitalizer_function___('s:tick')}

unlet! s:___revitalizer_sid
delfunction s:___revitalizer_function___

function! vital#_neoclojure#ConcurrentProcess#import() abort
