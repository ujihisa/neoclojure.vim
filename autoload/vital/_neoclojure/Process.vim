...
let s:___revitalizer_functions___ = {'get_last_status': s:___revitalizer_function___('s:get_last_status'),'has_vimproc': s:___revitalizer_function___('s:has_vimproc'),'iconv': s:___revitalizer_function___('s:iconv'),'shellescape': s:___revitalizer_function___('s:shellescape'),'spawn': s:___revitalizer_function___('s:spawn'),'system': s:___revitalizer_function___('s:system')}

unlet! s:___revitalizer_sid
delfunction s:___revitalizer_function___

function! vital#_neoclojure#Process#import() abort
